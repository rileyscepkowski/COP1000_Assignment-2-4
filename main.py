...
dependentDeduction = salary * Dependent_Deduction_Rate * numDependents


# Calculate total withholding and take home pay
totalWithholding = stateTax + federalTax - dependentDeduction # Subtract deductions because of dependents
